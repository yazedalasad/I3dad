...
const styles = StyleSheet.create({
  ...
  headerSmall: { marginTop: 8, color: '#DDE7FF', fontSize: 13, fontWeight: '700', lineHeight: 21, textAlign: 'right' },
  card: {
    marginTop: 14,
  ...
  cardSubtitle: { marginTop: 3, color: colors.secondary, fontSize: 12, fontWeight: '700', textAlign: 'right' },
  ...
  strengthText: { fontSize: 12, fontWeight: '900', textAlign: 'right' },
  helperText: { color: colors.secondary, fontSize: 12, fontWeight: '700', textAlign: 'right' },
