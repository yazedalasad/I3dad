...
export default function HomeScreen({ navigateTo }) {
  const { t, i18n } = useTranslation('home'); // ✅ force "home" namespace
  ...
  return (
    <ScrollView style={styles.container} contentContainerStyle={{ paddingBottom: 28 }}>
      ...
      >
        ...
        {user && studentData ? (
          <View style={styles.welcomeBanner}>
            ...
            <Text style={styles.welcomeText}>
              {t('welcome', { name: studentData.first_name })}
            </Text>
          </View>
        ) : null}
        ...
        {/* ✅ Fast Personality Test link (always translated) */}
        <TouchableOpacity
          style={styles.smallLink}
          onPress={() => (user ? navigateTo('personalityTest') : navigateTo('signup'))}
          activeOpacity={0.88}
        >
          {/* keep icons visually nice in RTL */}
