...
const styles = StyleSheet.create({
  ...
  heroSubtitle: { color: '#EAF0FF', marginTop: 4, fontSize: 14, lineHeight: 20, fontWeight: '800' },
  heroSummary: { color: '#F8FBFF', marginTop: 14, fontSize: 14, lineHeight: 22, fontWeight: '800' },
  confidencePill: { borderRadius: 999, backgroundColor: 'rgba(255,255,255,0.18)', paddingHorizontal: 10, paddingVertical: 7 },
  confidenceText: { color: '#fff', fontWeight: '900', fontSize: 12 },
  ...
  bodyText: { color: '#334155', fontSize: 14, lineHeight: 22, fontWeight: '700' },
  muted: { color: '#64748B', marginTop: 4, fontSize: 13, lineHeight: 19, fontWeight: '700' },
  ...
  traitTitle: { color: '#0F172A', fontWeight: '900', fontSize: 15, lineHeight: 20 },
  traitLabel: { color: '#64748B', marginTop: 3, fontWeight: '800', fontSize: 12, lineHeight: 17 },
  traitPct: { color: '#1E4FBF', fontSize: 28, lineHeight: 32, fontWeight: '900' },
  traitExplanation: { color: '#475569', marginTop: 8, fontSize: 13, lineHeight: 19, fontWeight: '700' },
  ...
  chartLabel: { flex: 1, color: '#102A68', fontWeight: '900', fontSize: 13 },
  chartPct: { color: '#1E4FBF', fontWeight: '900', fontSize: 13 },
  ...
  secondaryBtnText: { color: '#1E4FBF', fontWeight: '900', fontSize: 14 },
