...
const styles = StyleSheet.create({
  ...
  inlineAddTitle: { color: adminColors.primary, fontWeight: '900', fontSize: 17, textAlign: 'right' },
  inlineAddSub: { marginTop: 2, color: adminColors.muted, fontWeight: '800', fontSize: 17, textAlign: 'right' },
  cellText: { color: adminColors.text, fontWeight: '700', textAlign: 'right', fontSize: 17 },
  ...
  actionText: { color: adminColors.text, fontWeight: '900', fontSize: 16 },
  ...
  modalLabel: { color: adminColors.text, fontWeight: '900', fontSize: 17, textAlign: 'right' },
  ...
  inputError: { marginTop: -4, marginBottom: 8, color: adminColors.danger, fontSize: 17, fontWeight: '900', textAlign: 'right' },
  ...
  schoolOptionSub: { marginTop: 2, color: adminColors.muted, fontSize: 16, fontWeight: '700', textAlign: 'right' },
  ...
  settingSub: { marginTop: 4, color: adminColors.muted, fontWeight: '700', fontSize: 17, textAlign: 'right' },
});
