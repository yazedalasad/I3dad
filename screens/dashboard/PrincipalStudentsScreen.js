...
const styles = StyleSheet.create({
  ...
  smartLabel: { color: colors.secondary, fontSize: 10, fontWeight: '900', textAlign: 'right' },
  smartValue: { marginTop: 4, color: colors.dark, fontSize: 12, fontWeight: '900', textAlign: 'right' },
