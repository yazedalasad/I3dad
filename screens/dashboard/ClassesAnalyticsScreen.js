...
const styles = StyleSheet.create({
  ...
  metricLabel: { color: 'rgba(255,255,255,0.88)', fontSize: 11, fontWeight: '800', textAlign: 'right', marginTop: 2 },
  ...
  chartTitle: { color: colors.dark, fontSize: 15, fontWeight: '900', textAlign: 'right' },
  chartSubtitle: { marginTop: 2, color: colors.secondary, fontSize: 11, fontWeight: '800', textAlign: 'right' },
  ...
  donutLabel: { color: colors.secondary, fontSize: 11, fontWeight: '800' },
  ...
  careerLegendLabel: { color: colors.dark, fontSize: 13, fontWeight: '900', textAlign: 'right', maxWidth: 250 },
  careerLegendPercent: { color: colors.secondary, fontSize: 13, fontWeight: '900', minWidth: 36, textAlign: 'left' },
  ...
  verticalValue: { marginTop: 5, color: colors.dark, fontSize: 12, fontWeight: '900' },
  verticalLabel: { color: colors.secondary, fontSize: 10, fontWeight: '800', maxWidth: 78 },
  ...
  hBarValue: { color: colors.secondary, fontWeight: '900', fontSize: 12 },
  ...
  classTitle: { color: colors.dark, fontSize: 15, fontWeight: '900', textAlign: 'right' },
  classMeta: { marginTop: 3, color: colors.secondary, fontSize: 12, fontWeight: '800', textAlign: 'right' },
  ...
  smallStatValue: { color: colors.dark, fontWeight: '900', fontSize: 12, textAlign: 'right', maxWidth: '100%' },
  smallStatLabel: { marginTop: 2, color: colors.secondary, fontSize: 10, fontWeight: '800', textAlign: 'right' },
