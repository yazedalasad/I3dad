...
const styles = StyleSheet.create({
  ...
  label: { color: adminColors.text, fontWeight: '900', fontSize: 17, textAlign: 'right' },
  input: {
    minHeight: 46,
    borderRadius: 14,
    borderWidth: 1,
  ...
  inputError: { marginTop: -2, color: adminColors.danger, fontSize: 17, fontWeight: '900', textAlign: 'right' },
  ...
  schoolCity: { marginTop: 2, color: adminColors.muted, fontSize: 16, fontWeight: '700', textAlign: 'right' },
  ...
  stepText: { marginTop: 3, color: adminColors.muted, fontWeight: '700', fontSize: 17, textAlign: 'right' },
  ...
  inviteMeta: { marginTop: 3, color: adminColors.muted, fontWeight: '700', fontSize: 17, textAlign: 'right' },
  ...
  countChipText: { color: '#047857', fontSize: 17, fontWeight: '900' },
  statusChip: { borderRadius: 999, paddingHorizontal: 10, paddingVertical: 6 },
  statusChipText: { fontSize: 16, fontWeight: '900' },
  ...
  smallActionText: { color: adminColors.primary, fontWeight: '900', fontSize: 17 },
  smallDanger: { backgroundColor: '#FEF2F2', borderColor: '#FECACA' },
  smallDangerText: { color: adminColors.danger, fontWeight: '900', fontSize: 17 },
});
