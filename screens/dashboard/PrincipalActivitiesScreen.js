...
const styles = StyleSheet.create({
  ...
  metaText: { color: '#064E3B', fontWeight: '900', fontSize: 12 },
  ...
  activityMeta: { color: '#64748B', fontWeight: '700', fontSize: 12, marginTop: 5, textAlign: 'right' },
  ...
  scopeText: { fontWeight: '900', fontSize: 11 },
  ...
  fieldLabel: { color: '#064E3B', fontWeight: '900', fontSize: 12, marginBottom: 7, textAlign: 'right' },
  ...
  chipText: { color: '#047857', fontWeight: '900', fontSize: 12 },
