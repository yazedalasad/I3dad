...
const styles = StyleSheet.create({
  ...
  kicker: { color: colors.primary, fontSize: 12, fontWeight: '900', textAlign: 'right', marginBottom: 6 },
  ...
  insightLabel: { marginTop: 8, color: colors.secondary, fontSize: 12, fontWeight: '900', textAlign: 'right' },
  insightValue: { marginTop: 4, color: colors.dark, fontSize: 14, fontWeight: '900', textAlign: 'right', lineHeight: 19 },
  field: { marginTop: 8 },
  ...
  rowMeta: { marginTop: 4, color: colors.secondary, fontSize: 12, fontWeight: '800', textAlign: 'right' },
  ...
  analysisMeta: { marginTop: 7, color: colors.secondary, fontSize: 12, fontWeight: '800', textAlign: 'right', lineHeight: 18 },
  ...
  miniLabel: { marginTop: 2, color: colors.secondary, fontSize: 11, fontWeight: '800' },
  ...
  breakdownLabel: { color: colors.dark, fontSize: 12, fontWeight: '900', textAlign: 'right' },
  breakdownValue: { color: colors.secondary, fontSize: 12, fontWeight: '900' },
