...
const styles = StyleSheet.create({
  ...
  headerTitle: { color: '#DCFCE7', fontSize: 16, fontWeight: '800', textAlign: 'right' },
  ...
  heroStatValue: { color: '#fff', fontSize: 24, lineHeight: 30, fontWeight: '900', textAlign: 'right', maxWidth: '100%' },
  heroStatLabel: { marginTop: 4, color: '#EAF7EF', fontSize: 16, fontWeight: '800', textAlign: 'right' },
  ...
  statNumber: { marginTop: 12, color: colors.dark, fontSize: 28, lineHeight: 34, fontWeight: '900', textAlign: 'right' },
  statLabel: { marginTop: 3, color: colors.secondary, fontSize: 17, fontWeight: '800', textAlign: 'right' },
  sectionTitle: { marginTop: 22, marginBottom: 10, color: colors.dark, fontSize: 22, lineHeight: 30, fontWeight: '900', textAlign: 'right' },
  actionsGrid: { gap: 10 },
  ...
  actionTitle: { marginTop: 10, color: colors.dark, fontSize: 17, fontWeight: '900', textAlign: 'right' },
  actionDescription: { marginTop: 4, color: colors.secondary, fontSize: 17, fontWeight: '700', lineHeight: 19, textAlign: 'right' },
  ...
  cardTitle: { color: colors.dark, fontSize: 17, fontWeight: '900', textAlign: 'right' },
  cardMeta: { color: colors.secondary, fontSize: 17, fontWeight: '900' },
  ...
  reportDescription: { marginTop: 5, color: colors.secondary, fontSize: 17, fontWeight: '800', lineHeight: 18, textAlign: 'right' },
  ...
  tabText: { color: colors.secondary, fontSize: 16, fontWeight: '900' },
  ...
  languageTabText: { color: colors.primary, fontSize: 16, fontWeight: '900' },
});
