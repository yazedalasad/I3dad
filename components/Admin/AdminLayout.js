...
const styles = StyleSheet.create({
  ...
  brandSubtitle: { color: '#D9E5FF', fontSize: 16, fontWeight: '800', textAlign: 'right' },
  ...
  navText: { flex: 1, color: '#EAF0FF', fontSize: 17, fontWeight: '900', textAlign: 'right' },
  ...
  pageSubtitle: { flexShrink: 1, marginTop: 4, color: adminColors.muted, fontSize: 16, fontWeight: '700', textAlign: 'right', writingDirection: 'rtl' },
  pageSubtitleMobile: { fontSize: 17, lineHeight: 18 },
  ...
  adminName: { flexShrink: 1, minWidth: 0, color: adminColors.text, fontWeight: '900', fontSize: 17 },
  ...
  cardTitle: { color: adminColors.text, fontSize: 20, lineHeight: 28, fontWeight: '900', textAlign: 'right' },
  cardSubtitle: { marginTop: 3, color: adminColors.muted, fontSize: 17, fontWeight: '700', textAlign: 'right' },
  ...
  statLabel: { marginTop: 8, color: adminColors.muted, fontSize: 16, fontWeight: '800', textAlign: 'right' },
  statValue: { marginTop: 3, color: adminColors.text, fontSize: 28, lineHeight: 34, fontWeight: '900', textAlign: 'right' },
  statHint: { marginTop: 2, color: adminColors.muted, fontSize: 16, fontWeight: '700', textAlign: 'right' },
  ...
  filterText: { flexShrink: 1, color: adminColors.text, fontWeight: '800', fontSize: 17, textAlign: 'center' },
  filterDropdown: {
    position: 'absolute',
    top: 48,
    left: 0,
  ...
  filterOptionText: { color: adminColors.text, fontWeight: '800', fontSize: 17, textAlign: 'right', writingDirection: 'rtl' },
  ...
  th: { padding: 12, color: adminColors.text, fontWeight: '900', textAlign: 'right', fontSize: 17 },
  td: { minHeight: 50, justifyContent: 'center', paddingHorizontal: 12, paddingVertical: 8 },
  tdText: { color: adminColors.text, fontWeight: '700', textAlign: 'right', fontSize: 16, lineHeight: 24 },
  ...
  mobileRecordLabel: { width: 112, color: adminColors.muted, fontSize: 16, fontWeight: '900', textAlign: 'right' },
  mobileRecordValue: { flex: 1, minWidth: 0, alignItems: 'flex-end' },
  mobileRecordText: { color: adminColors.text, fontWeight: '800', fontSize: 17, lineHeight: 18, textAlign: 'right' },
  ...
  chartLabel: { width: 110, color: adminColors.text, fontWeight: '800', fontSize: 17, textAlign: 'right' },
  ...
  chartValue: { width: 42, color: adminColors.muted, fontWeight: '900', fontSize: 17, textAlign: 'left' },
  formField: { gap: 6 },
  formLabel: { color: adminColors.text, fontWeight: '900', textAlign: 'right' },
  formInput: { minHeight: 48, fontSize: 16, lineHeight: 24, borderRadius: 14, borderWidth: 1, borderColor: adminColors.border, backgroundColor: '#fff', color: adminColors.text, paddingHorizontal: 12, fontWeight: '700' },
